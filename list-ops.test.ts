...
describe.skip("concat lists and lists of lists into new list", () => {
  xit("empty list", () => {
    const list1 = List.create();
    const list2 = List.create();
...
describe.skip("filter list returning only values that satisfy the filter function", () => {
  xit("empty list", () => {
    const list1 = List.create();
...
describe.skip("returns the length of a list", () => {
  xit("empty list", () => {
    const list1 = List.create();
...
describe.skip("returns a list of elements whose values equal the list value transformed by the mapping function", () => {
  xit("empty list", () => {
    const list1 = List.create();
...
describe.skip("folds (reduces) the given list from the left with a function", () => {
  xit("empty list", () => {
    const list1 = List.create();
...
describe.skip("folds (reduces) the given list from the right with a function", () => {
  xit("empty list", () => {
    const list1 = List.create();
...
describe.skip("reverse the elements of a list", () => {
  xit("empty list", () => {
    const list1 = List.create();
